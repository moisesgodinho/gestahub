...
// --- INÍCIO DA MUDANÇA 2 ---
// 1. Extrair o item da lista para um componente separado e memoizado
const JournalEntryItem = memo(function JournalEntryItem({ entry, onEdit, openDeleteConfirmation, getMoodLabel }) {
  return (
    <div
      key={entry.id}
...
export default function JournalHistory({ entries, onEdit, user }) {
  // ... (todo o resto do código do componente JournalHistory permanece o mesmo)
        ...
        {availableMonths.length > 0 ? (
          <div>
            ...
            <div className="space-y-4">
              {/* --- INÍCIO DA MUDANÇA 3 --- */}
              {/* 2. Usar o novo componente memoizado aqui */}
