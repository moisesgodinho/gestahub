        ...
        <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-1">
                {entry.symptoms.map((symptom) => (
                  <span
                    key={symptom}
                    className="text-sm bg-rose-100 dark:bg-rose-900/50 text-rose-800 dark:text-rose-200 px-3 py-1 rounded-full"
                  >
                    {symptom}
                  </span>
                ))}
          ...
          {entry.notes && (
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-700/50 p-3 rounded-md">
                {entry.notes}
              </p>
            </div>
          )}
