      ...
      <div className="w-full md:w-1/2 p-8 sm:p-10 flex flex-col justify-center">
        ...
        <ul className="mt-6 space-y-3 text-slate-600 dark:text-slate-400">
          <li className="flex items-start gap-3">
            <CheckIcon /> <span>Calculadoras precisas (DUM e Ultrassom)</span>
          </li>
          <li className="flex items-start gap-3">
            <CheckIcon /> <span>Diário de Sintomas e Humor</span>
          </li>
          <li className="flex items-start gap-3">
            <CheckIcon /> <span>Acompanhamento de Peso</span>
          </li>
          <li className="flex items-start gap-3">
            <CheckIcon />{" "}
          ...
          <li className="flex items-start gap-3">
            <CheckIcon /> <span>Cronômetro de Contrações</span>
          </li>
          <li className="flex items-start gap-3">
