...
const navLinks = [
  {
    ...
    description: "Veja o resumo da sua gestação.",
  },
  {
    href: "/diario-de-sintomas",
    title: "Diário de Sintomas",
    description: "Registre seu humor e sintomas diários.",
  },
  {
    href: "/acompanhamento-de-peso",
    title: "Acompanhamento de Peso",
    description: "Registre seu peso e veja seu progresso.",
  },
  {
    href: "/contador-de-movimentos",
    title: "Contador de Movimentos",
    description: "Monitore os movimentos do seu bebê.",
  },
  {
    href: "/cronometro-de-contracoes",
    title: "Cronômetro de Contrações",
    description: "Monitore a duração e frequência das contrações.",
  },
];
