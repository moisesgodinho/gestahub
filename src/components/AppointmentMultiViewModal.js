...
export default function AppointmentMultiViewModal({
  isOpen,
  onClose,
  onEdit,
  onDelete,
          ...
          {sortedAppointments.map((appointment, index) => (
            ...
            >
              <div className="flex justify-between items-start">
                <h4
                  className={`text-lg font-semibold mb-2 ${appointment.type === "ultrasound" ? "text-rose-500 dark:text-rose-400" : "text-indigo-600 dark:text-indigo-400"}`}
                >
              ...
              <div className="space-y-3 text-sm text-slate-700 dark:text-slate-300">
                ...
                {appointment.notes && (
                  <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 italic whitespace-pre-wrap">
                      {appointment.notes}
                    </p>
                  </div>
                )}
